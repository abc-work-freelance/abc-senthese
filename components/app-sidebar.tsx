    ...
    <aside className="hidden min-h-screen border-r bg-white lg:flex lg:flex-col" style={{ borderColor: "var(--med-border)" }}>
      ...
      <div className="flex-1 space-y-6 px-5 pb-5">
        <div className="space-y-2">
          ...
          <div className="space-y-1">
            ...
            <SidebarLink href="/dashboard#commands" label="Commands" icon={FileText} active={pathname === "/dashboard"} count={12} />
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1">
            <SidebarLink href="/dashboard/products" label="Products" icon={Package} active={pathname === "/dashboard/products"} />
        ...
        {role === "ADMIN" && (
          <div className="space-y-2">
            ...
            <div className="space-y-1">
              ...
              <SidebarLink href="/dashboard/permissions" label="Permissions" icon={ShieldCheck} active={pathname === "/dashboard/permissions"} />
            </div>
          </div>
        )}
      </div>
      ...
      <div className="mt-auto border-t px-5 py-4" style={{ borderColor: "var(--med-border)" }}>
        <div className="rounded-xl border border-[#E8ECF0] bg-[#F8FAFC] p-3">
          ...
          <div className="mt-3">
            <Link href="/dashboard/settings" className="mb-2 block">
              <button
                type="button"
